...
export default function Navigation() {
  ...
  return (
    <div className="top-0 left-0 z-[999] w-full bg-white shadow-md">
      {/* Mobile menu */}
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  <span className="sr-only">S&R Jewel</span>
                  <img
                    alt=""
                    src="https://logomoose.com/wp-content/uploads/2016/01/18.jpg"
